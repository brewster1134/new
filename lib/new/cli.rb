...
class New::Cli < Thor
  desc 'templates', 'List all available templates'
  def templates
    # check ~/.new and .new in pwd
  end

  desc 'init', 'Create a default configuration file'
  def init
  end

  desc 'project [TEMPLATE] [NAME]', 'Create a new project with a given template'
